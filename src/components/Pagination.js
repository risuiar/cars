...
const Page = ({ page, selected, totalPageCount }) => {
  ...
  return (
    <li>
      <Link
        to={{ pathname: `/${page}` }} className={cn('flex items-center justify-center px-4 h-10 leading-tight  dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'
